                                ...
                                <table class="table table-hover ">
                                    <thead>
                                        <tr class="no-b">
                                            ...
                                            <th><span style="font-weight: bold">DATE:</span> <fmt:formatDate type="both" dateStyle="short" timeStyle="short" pattern="MM/dd/yyyy hh:mm a" value="${model.invoice.createdDate}" /></th>
                                            <th><span style="font-weight: bold">EMPLOYEE:</span> ${model.invoice.employeeName}</th>
                                        </tr>
                                        <tr class="no-b">
                                            <th><span style="font-weight: bold">TAX:</span> ${model.invoice.taxId}</th>
                                            <th><span style="font-weight: bold">CUSTOMER:</span> ${model.clientName}</th>
                                            <th><span style="font-weight: bold">PHONE:</span> ${model.clientPhone}</th>
                                        </tr>
                                    </thead>
<%--                                    <tbody>--%>
<%--                                        <tr class="no-b">--%>
