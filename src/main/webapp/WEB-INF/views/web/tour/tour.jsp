...
<body>
    ...
    <section class="section-reviews">
      <div class="reviews">
        <c:forEach var="item" items="${model.reviews}">
          <div class="reviews__card">
            <div class="reviews__avatar">
              <img
                src="/template/web/img/users/default.jpg"
                alt="${item.clientName}"
                class="reviews__avatar-img"
              />
              <h6 class="reviews__user">${item.clientName}</h6>
            </div>
            <p class="reviews__text">
              ${item.review}
            </p>
            <div class="reviews__rating">
              <c:forEach var="star" items="${arrayStars}">
                <c:if test="${item.rating >= star}">
